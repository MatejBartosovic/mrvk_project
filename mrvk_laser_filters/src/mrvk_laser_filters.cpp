...
MrvkLaserFilters::MrvkLaserFilters():
        min_accept_size_(1), enable_isolated_points_filter_(false){
    //
}
...
bool MrvkLaserFilters::configure() {
    ...
    nh.getParam("scan_filter_chain/mrvk_laser_filters/params/isolated_points_filter/enabled", enable_isolated_points_filter_);
